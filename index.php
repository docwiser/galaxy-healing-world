...
<input type="text" id="verify_value" name="verify_value" placeholder="Enter your phone number used to register previously" required>
...
<option value="" selected disabled>Select approximate age</option>
<?php for($i = 1; $i <= 100; $i++): ?>
...
<option value="" selected disabled>Select area/village</option>
</select>
</div>
...
<option value="" selected disabled>choose your ocupation</option>
...
<option value="" selected disabled>Choose your educational background</option>
